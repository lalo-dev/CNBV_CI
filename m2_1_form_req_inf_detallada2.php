            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Requerimiento informaci&oacute;n 2</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        ...
                        <li><a href="m2_2_requerimiento_informacion_2">Requerimiento informaci&oacute;n 2</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <div class="block">
                <ul class="nav nav-tabs" data-toggle="tabs">
                    ...
                    <li>
                        <a href="#area-auditada">&Aacute;rea auditada 1</a>
                    </li>
                    <li>
                ...
                <div class="block-content tab-content bg-white">
                            ...
                            <div class="col-lg-4 col-lg-offset-2">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-flat clearfix">
                                        ...
                                        <span class="h4 text-white-op">Informaci&oacute;n</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4">
                    ...
                    <div class="tab-pane fade fade-up" id="area-auditada">
                        ...
                        <div class="border-b push-30">
                            <h2 class="push-10">*<span class="h5 font-w400 text-muted"> &Aacute;rea auditada</span></h2>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="form-material floating">
                                                <input class="form-control" type="text" id="dias-hab" name="dias-hab">
                                                <label for="dias-hab">Dias habiles:</label>
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-material floating">
                                                <textarea class="form-control" id="requerimi" name="requerimi" rows="3"></textarea>
                                                <label for="requerimi">Requerimientos:</label>
