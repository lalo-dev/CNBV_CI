            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Solicitud de asesoría no vinculante<small> PRA</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Solicitud de asesoría no vinculante</li>
                        <li>PRA</li>
                    </ol>
                </div>
            </div>
                            ...
                            <tr>
                                <td>
                                    <h3 class="h5 font-w600 push-10">
                                        <a class="link-effect" href="m4_solicitud_asesoria_no_vinculante_detalle">Auditoría XXXX XXXXX</a>
                                    </h3>
                                </td>
