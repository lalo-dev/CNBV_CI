                            ...
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">9</span> <span class="h4 text-white-op">Áreas</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">1</span> <span class="h4 text-white-op">Catálogo</span>
                                    </div>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">1</span> <span class="h4 text-white-op">Direcciones Generales</span>
                                    </div>
                                </a>
                            </div>
                        </div>
