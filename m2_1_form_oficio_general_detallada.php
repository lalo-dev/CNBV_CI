            ...
            <div class="row items-push">
                <div class="col-sm-5">
                    <h1 class="page-heading">
                        Detalle <small>Oficio general</small>
                    </h1>
                </div>
        ...
        <div class="content">
            <div class="block">
                ...
                <div class="block-content tab-content bg-white">
                            ...
                            <div class="col-lg-2 col-lg-offset-4">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-flat clearfix">
                                        ...
                                        <span class="h4 text-white-op">General</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-2">
                    ...
                    <!-- Modificaciones -->
                    <div class="tab-pane fade fade-up" id="search-ofici">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="form-material">
												...
												<label for="material-text">No.</label>
											</div>
                                        </div>
                                    </div>
                                    <div class="form-group">
