            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Cédula de Seguimiento de Observaciones</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Seguimiento</li>
                        <li><a href="m3_cedula_seguimiento">Cédula de Seguimiento de Observaciones</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="saldo-aclarar" name="saldo-aclarar">
                                        <label for="saldo-aclarar">Saldo por aclarar</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="saldo-recuperar" name="saldo-recuperar">
                                        <label for="saldo-recuperar">Saldo por recuperar</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-material floating">
                                        <input class="form-control" type="text" id="avance" name="avance">
                                ...
                                <div class="col-md-6">
                                    <div class="block block-themed block-bordered">
                                        ...
                                        <div class="block-content block-content-full text-center">
                                            <span class="text-center"><strong>Titulo de la observación</strong></span>
                                            <div class="col-md-12">
                                                <div class="form-material floating">
                                                    <textarea class="form-control" id="ooroginal" name="ooroginal" rows="3"></textarea>
                                                    <label for="ooroginal">Observación original</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-material floating">
                                                    <textarea class="form-control" id="recom-correc" name="recom-correc" rows="3"></textarea>
                                                    <label for="recom-correc">Recomendaciones correctivas</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-material floating">
                                                    <textarea class="form-control" id="recom-prev" name="recom-prev" rows="3"></textarea>
                                                    <label for="recom-prev">Recomendaciones preventivas</label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="block block-themed block-bordered">
                                        <div class="block-header bg-primary-dark">
                                            <h3 class="block-title">Situación actual</h3>
                                        </div>
                                        <div class="block-content block-content-full text-center">
                                            <div class="col-md-12">
                                                <div class="form-material floating">
                                                    <textarea class="form-control" id="recom-correc2" name="recom-correc2" rows="3"></textarea>
                                                    <label for="recom-correc2">Recomendaciones correctivas</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-material floating">
                                                    <textarea class="form-control" id="recom-prev2" name="recom-prev2" rows="3"></textarea>
                                                    <label for="recom-prev2">Recomendaciones preventivas</label>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-material floating">
                                                    <input type="text" class="js-datepicker form-control" data-date-format="dd/mm/yyyy" id="ffirma" name="ffirma">
                                                    <label for="ffirma">Fecha de firma</label>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="form-material floating">
                                                    <div class="form-material floating">
                                                        <input type="text" class="js-datepicker form-control" data-date-format="dd/mm/yyyy" id="fimplem" name="fimplem">
                                                        <label for="fimplem">Fecha de implementación</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
