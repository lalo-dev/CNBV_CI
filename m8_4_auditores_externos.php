                    ...
                    <div class="row items-push">
                        <div class="col-sm-7">
                            <h1 class="page-heading">
                                Auditores externos <small>Otras actividades</small>
                            </h1>
                        </div>
                        ...
                        <div class="block-content tab-content bg-white">
                            ...
                            <div class="tab-pane" id="btabs-alt-static-settings">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-2 col-lg-2">
                                        <a class="block block-link-hover3 text-center" href="m8_4_auiditores externos_form.php">
                                            <div class="block-content block-content-full">
                                                <i class="si si-doc fa-4x text-primary"></i>
                                                <div class="font-w600 push-15-t">Agregar Auditor Externo</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
