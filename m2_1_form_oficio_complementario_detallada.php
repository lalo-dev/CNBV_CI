                            ...
                            <div class="col-lg-4 col-lg-offset-2">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-flat clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">Oficio</span>
                                        <span class="h4 text-white-op">Complementario</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            <div class="form-material floating">
                                                <select class="form-control" id="orden" size="1">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-material floating">
                                                <select class="form-control" id="objeto" size="1">
                                                    <option></option><!-- Empty value for demostrating material select box -->
                                                    <option value="1">-----</option>
                                                </select>
                                                <label for="material2">Objeto / Periodo</label>
                                            </div>
                                        </div>
										<div class="col-md-4">
                                            <div class="form-material floating">
                                                <select class="form-control" id="revisar" size="1">
                                                    <option></option><!-- Empty value for demostrating material select box -->
                                                    <option value="1">-----</option>
                                                </select>
                                                <label for="material2">Revisar</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="form-material floating">
                                                ...
                                                <label for="material-textarea-small2">Motivo:</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="form-material floating">
                                                <textarea class="form-control" id="ob_period" rows="3"></textarea>
                                                <label for="material-textarea-small2">Objeto / Periodo:</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
