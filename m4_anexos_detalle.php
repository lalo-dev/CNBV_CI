            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Anexos</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>PRA</li>
                        <li><a href="m4_anexos">Anexos</a></li>
                        <li>Detalle</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="block-content tab-content bg-white">
                                            ...
                                            <div class="col-md-4 col-md-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 font-w700 text-white">Anexos </span>
                    ...
                    <div class="tab-pane fade fade-up" id="area-auditada">
                        ...
                        <div class="border-b push-30">
                            <h2 class="push-10">*<span class="h5 font-w400 text-muted"> Anexos</span></h2>
                        </div>
