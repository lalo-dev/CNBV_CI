            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> C&eacute;dula resumen de actividades</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        ...
                        <li><a href="m2_2_cedula_resumen_actividades">C&eacute;dula resumen de actividades</a></li>
						<li>Detalle</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="content">
            <form class="block">
                ...
                <div class="block-content tab-content bg-white">
                                ...
                                <div class="col-lg-4 col-lg-offset-2">
                                    <a class="block block-link-hover2" href="javascript:void(0)">
                                        <div class="block-content block-content-full bg-flat clearfix">
                                            ...
                                            <span class="h4 font-w700 text-white">C&eacute;dula Resumen</span>
                                            <span class="h4 text-white-op">Actividades</span>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-4">
                    ...
                    <!-- End Info -->
                    <!-- Inicia Area A -->
                    <div class="tab-pane fade fade-up" id="resum">

                        <div class="border-b push-30">
                            <h2 class="push-10">*<span class="h5 font-w400 text-muted"> Resumen</span></h2>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-material floating">
                                    <select class="form-control" id="procedimiento" name="procedimiento" size="1">
                            ...
                            <div class="col-md-12">
                                <div class="form-material floating">
                                    ...
                                    <label for="document">Documentación</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-material floating">
                                    <textarea class="form-control" id="fundamentol" name="fundamentol" rows="2"></textarea>
                                    <label for="document">Fundamento legal</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label>Inicio y termino programada:</label>
                            </div>
                            <div class="col-md-4">
                                <div class="form-material">
                                    <input class="js-datepicker form-control" type="text" id="example-datepicker1" name="example-datepicker1" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                    <label for="example-datepicker1">Inicio</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-material">
                                    <input class="js-datepicker form-control" type="text" id="example-datepicker2" name="example-datepicker2" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                    <label for="example-datepicker2">Termino</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label>Inicio y termino real:</label>
                            </div>
                            <div class="col-md-4">
                                <div class="form-material">
                                    ...
                                    <label for="example-datepicker3">Inicio</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-material">
                                    <input class="js-datepicker form-control" type="text" id="example-datepicker4" name="example-datepicker4" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                    <label for="example-datepicker4">Termino</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label class="css-input switch switch-info" title="Aplicado">
                                    <input type="checkbox"><span></span> Aplicado
                                </label>
                            </div>
                            <div class="col-md-12">
                                <div class="form-material floating">
                            ...
                            <div class="col-md-6">
                                <div class="form-material floating">
                                    <select class="form-control" id="papel" name="papel" size="1">
                                        <option></option><!-- Empty value for demostrating material select box -->
                                        <option value="1">Option #1</option>
                                        <option value="2">Option #2</option>
                                        <option value="3">Option #3</option>
                                    </select>
                                    <label for="papel">Papel de trabajo</label>
                                </div>
                            </div>
                            <div class="col-md-3 col-md-offset-3">
                                <button class="btn btn-sm btn-default" type="button">Limpiar</button>
                        ...
                        <div class="block-content">
                            <table class="table-responsive table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 10%;" colspan="2">Documentación</th>
                                    <th class="text-center" style="width: 1%;" colspan="2">Fecha</th>
                                    <th class="text-center" style="width: 1%;" colspan="2">Aplicado</th>
                                    <th class="text-center" style="width: 1%;">Comentarios</th>
                                    <th class="text-center" style="width: 1%;">Referencia de trabajo</th>
