            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Solicitud de asesoria no vinculante</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>PRA</li>
                        <li><a href="m4_solicitud_asesoria_no_vinculante">Solicitud de asesoria no vinculante</a></li>
                        <li>Detalle</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="block-content tab-content bg-white">
                                            ...
                                            <div class="col-md-4 col-md-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 font-w700 text-white">Solicitud de asesoria no vinculante </span>
                    ...
                    <div class="tab-pane fade fade-up" id="solicitud">
                        ...
                        <div class="border-b push-30">
                            <h2 class="push-10">*<span class="h5 font-w400 text-muted"> Solicitud de asesoría no vinculante</span></h2>
                        </div>
                            ...
                            <div class="col-md-12">
                                <form class="form-horizontal push-10-t" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="<cuer></cuer>po">Titular</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="orden">Fecha Auditoria</label>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="tiempo_real">Auditoría</label>
                                        <div class="col-md-3">
                                            <input class="form-control" type="text" id="tiempo_real" name="tiempo_real" placeholder="Auditoría">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="<cuer></cuer>po">DGA</label>
                                        <div class="col-sm-3">
                                            <select class="form-control" id="example-select" name="example-select" size="1">
                                                <option value="0">DGA...</option>
                                                <option value="1">DGA 1</option>
                                                <option value="2">DGA 2</option>
                                                <option value="3">DGA 3</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="block col-md-7 col-md-offset-0">
                                            <div class="block-content">
