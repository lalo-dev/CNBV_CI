            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Reportes AAI<small>Administración</small>
                    </h1>
                </div>
        ...
        <div class="content">
            <div class="block">
                <ul class="nav nav-tabs" data-toggle="tabs">
                    <li class="active">
                        <a href="#search-generales">Trimestre actual</a>
                    </li>
                            ...
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="m50_2_estatus_docs">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">-</span> <span class="h4 text-white-op">Reporte de hallazgos</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="m50_3_alcances">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        <i class="fa fa-warning fa-2x text-white pull-right"></i>
                                        <span class="h4 font-w700 text-white">-</span> <span class="h4 text-white-op">Reporte de observaciones</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">-</span> <span class="h4 text-white-op">Reporte de seguimiento</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        ...
                                        <span class="h4 font-w700 text-white">-</span> <span class="h4 text-white-op">POT 1</span>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a class="block block-link-hover2" href="javascript:void(0)">
                                    <div class="block-content block-content-full bg-primary clearfix">
                                        <i class="fa fa-clock-o fa-2x text-white pull-right"></i>
                                        <span class="h4 font-w700 text-white">-</span> <span class="h4 text-white-op">POT 2</span>
                                    </div>
                                </a>
                            </div>
                        </div>
