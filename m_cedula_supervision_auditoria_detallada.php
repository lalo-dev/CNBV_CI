            ...
            <div class="row items-push">
                <div class="col-sm-7">
                    <h1 class="page-heading">
                        Detalle<small> Cédula de supervisón de auditoría</small>
                    </h1>
                </div>
                <div class="col-sm-5 text-right hidden-xs">
                    <ol class="breadcrumb push-10-t">
                        <li>Auditoría</li>
                        <li>Cierre</li>
                        <li><a href="#">Cédula de supervisón de auditoría</a></li>
                        <li>Detalle</li>
                    </ol>
                </div>
            </div>
                                            ...
                                            <div class="col-md-4 col-md-offset-2">
                                                <a class="block block-link-hover2" href="javascript:void(0)">
                                                    <div class="block-content block-content-full bg-flat clearfix">
                                                        ...
                                                        <span class="h4 text-white-op">de envío</span>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                            ...
                            <table class="table table-condensed">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Concepto_1</td>
                                        <td>
                                            <label class="css-input switch switch-success" title="Rev">
